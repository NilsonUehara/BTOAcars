...
function CheckFSAcarsInfo() {
	// Verify input
	if (!isset($_POST['pilot'])) { return 0; }
	if ($_POST['version']!='BTOACARS') { return 0; }
...
function GetFSAcarsInfo() {
	...
	$fsacars_pirep = array (
		...
		"tour" => $_POST['tour'],
		"more" => $_POST['more'],
		"fsacars_log" => $_POST['log']	// Get complete FSAcars log
	);
	...
	*/
	...
	fwrite($fe, "[DEBUG ".date("d.m.y H:i:s")."] PILOT: ".$_POST['pilot']." DATE: ".$_POST['date']." TIME: ".$_POST['time']." CALLSIGN: ".$_POST['callsign']." REG: ".$_POST['reg']." ORIG: ".$_POST['origin']." DEST: ".$_POST['dest']." EQUIP: ".$_POST['equipment']." FUEL: ".$_POST['fuel']." DURATION: ".$_POST['duration']." DIST: ".$_POST['distance']." MORE: ".$_POST['more']." LOG: ".$_POST['log']."\n");
	fclose($fe);
